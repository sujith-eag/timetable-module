#!/usr/bin/env python3
"""
Build Assignments for Semester 4
=================================

This script orchestrates the complete generation of teaching assignments
for Semester 4 by coordinating all Phase 2 modules:
- Assignment generation
- Constraint building
- Room preference extraction

Output: teachingAssignments_sem4.json
    ...
    def build(self) -> Dict[str, Any]:
        ...
        output = {
            "metadata": {
                ...
                "generator": "build_assignments_sem4.py",
                "notes": "Semester 4 - Saturday only, project work and seminar"
            },
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Build teaching assignments for Semester 4")
    parser.add_argument(
        "--data-dir",
        type=str,
        default=None,
    ...
    print("=" * 80)
    print("🚀 Stage 3 - Building Teaching Assignments for Semester 4")
    print("=" * 80)
    
    try:
        builder = AssignmentBuilder(semester=4, data_dir=args.data_dir)
        output = builder.build()
        
        # Save to file
        output_path = builder.save(output, "teachingAssignments_sem4.json")
