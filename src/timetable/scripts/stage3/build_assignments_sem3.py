"""
Build Assignments for Semester 3
=================================

This script orchestrates the complete generation of teaching assignments
for Semester 3 by coordinating all Phase 2 modules:
- Assignment generation
- Constraint building
- Room preference extraction

Output: teachingAssignments_sem3.json
    ...
    def build(self) -> Dict[str, Any]:
        ...
        output = {
            "metadata": {
                ...
                "generator": "build_assignments_sem3.py"
            },
...
def main():
    ...
    print("=" * 80)
    print("STAGE 3: BUILD TEACHING ASSIGNMENTS - SEMESTER 3")
    print("=" * 80)
    
    # Build assignments
    builder = AssignmentBuilder(semester=3)
    output = builder.build()
    
    # Save to file
    print("\n6. Saving assignments...")
    output_path = builder.save(output, "teachingAssignments_sem3.json")
